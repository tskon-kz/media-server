M = {
    ...
    "qb_allow_hosts_btn":   "🌐 Allow access from any host",
    "qb_allow_hosts_ok":    "✅ Host validation disabled — you can now open via IP/Tailscale",
    "qb_allow_hosts_err":   "❌ Failed to update settings",
